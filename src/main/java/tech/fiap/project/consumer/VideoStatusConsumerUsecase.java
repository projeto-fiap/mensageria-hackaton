...
//
// private final ObjectMapper objectMapper = new ObjectMapper(); // Instancia o
// ObjectMapper para conversão
//
// @Value("${spring.kafka.email-consumer.topic}")
// private String emailTopic;
//
// @KafkaListener(topics = " v1.video-upload-status", groupId = "notifier-service}")
// public void consumeVideoStatus(String message) {
// try {
// VideoStatusMessage videoStatus = objectMapper.readValue(message,
// VideoStatusMessage.class);
//
// System.out.println("Received video status: " + videoStatus);
//
// sendEmail(videoStatus.getUserEmail(), videoStatus.getVideoName(),
