...
@Component
@Slf4j
public class ErrorStatusEmailStrategy implements EmailStrategy {

    private final VideoInfoService videoInfoService;
    private final EmailService emailService;

    public ErrorStatusEmailStrategy(VideoInfoService videoInfoService, EmailService emailService) {
    ...
    public void handle(VideoStatusMessage message) {
        ...
        emailService.sendEmail(personWithVideoDTO.getPersonEmail(), personWithVideoDTO.getVideoNome(), "Erro no processamento do video! Consulte a plataforma para mais informações!");
